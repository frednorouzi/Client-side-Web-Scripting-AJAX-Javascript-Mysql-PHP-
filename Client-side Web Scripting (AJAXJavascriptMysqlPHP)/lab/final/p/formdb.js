...
function useResponse()
{
  ...
  myNames.length = 0;
   ...
   /*------cookiecheck-----------*/
	...
	newNode.innerHTML = "<a href='#' style='color:white'>click here to move this message to VIP </a>";
...
var lastnames = new Array("London", "Skywalker", "Coltrane", "Chaplin", "Simpson","Vadar");

var emails = new Array("me@coolbeans.com", "you@hotdogs.com", "us@relish.com", "them@mustard.com", "it@mayo.com","yum@horseradish.com");

var subjects = new Array("food", "home brewing", "gardening", "intergalactic travel", "transcendental meditation","coding the web");

var blogs = new Array("i like food", "i like to make beer", "i like to garden", "i like exploring the galaxy", "i enjoy transcendental meditation","i like coding the web");
