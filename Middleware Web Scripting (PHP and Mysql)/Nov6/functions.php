...
<th># of Animals</th>
	...
	<td><a href='pets1.php?editowner=yes&ownerid=$ownerid'>$fname</a></td>
	<td>$lname</td>
	<td>$city</td>
	<td>
	<a href='pets1.php?animalownership=yes&ownerid=$ownerid&fname=$fname&lname=$lname'>$num</a></td>
	</tr>";
...
<th><a href='pets1.php?sort=city'>City</a></th>
	...
	print "<tr>
	<td><a href='pets1.php?petid=$petid&delpet=yes'
	onclick='return confirm(\"are you sure\")'>Delete Pet</td>
